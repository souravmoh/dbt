{% macro final_bo_transformation_1(col1,col2) %}
    (case
    when {{col1 }} is not null and {{col2}}=2 then 100-{{col1}}
    else {{col1}}
    end)
{% endmacro %}
{% macro final_bo_transformation_2(col3,col4) %}
    (case
...
{% endmacro %}
{% macro final_bo_transformation_3_and_4(col5,col6,col7) %}
    (case
...
{% endmacro %}
{% macro final_bo_transformation_5(col8,col9) %}
(case
...
{% endmacro %}
{% macro final_bo_transformation_6(col10) %}
(case
